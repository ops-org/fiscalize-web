package br.com.cotasparlamentares.cargafiscalize.util;
...
public class Utilidade {
	...
	// Log
	private static final String LOGGER_PADRAO = "br.com.cotasparlamentares.cargafiscalize";
	private static final String LOG_FILE_NAME = "carga"; // 1Mb tamanho max do log
